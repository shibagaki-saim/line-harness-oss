...
#### 9-1: 個別チャット `/chats`
- [ ] チャット一覧が表示される（友だちとのチャットが出る）
- [ ] チャットを開いてメッセージ履歴が表示される
- [ ] テキストメッセージを送信できる
- [ ] ステータス変更（未読→対応中→解決済）が動作する
...
- 現在取り組んでいる箇所: **Phase 9 動作確認ツアー 開始前**
- **次にやること:** Phase 9-1 `/chats` の動作確認から開始
