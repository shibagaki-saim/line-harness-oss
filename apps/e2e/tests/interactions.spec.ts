...
test.describe('9-2: オートメーション', () => {
  ...
  test('ルールを作成して保存できる', async ({ page }) => {
    ...
    await expect(page.getByText('E2Eテストルール').first()).toBeVisible()
...
test.describe('9-3: スコアリング', () => {
  ...
  test('スコアリングルールを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByText('E2Eスコアルール').first()).toBeVisible()
...
test.describe('9-4: Webhook', () => {
  ...
  test('受信Webhookを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByText('E2Eテスト受信Webhook').first()).toBeVisible()
  ...
  test('送信Webhookを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByText('E2Eテスト送信Webhook').first()).toBeVisible()
...
test.describe('9-5: 通知', () => {
  ...
  test('通知ルールを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByText('E2Eテスト通知ルール').first()).toBeVisible()
...
test.describe('9-7: CV計測', () => {
  ...
  test('CVポイントを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByRole('cell', { name: 'E2EテストCV' }).first()).toBeVisible()
...
test.describe('9-12: スタッフ管理', () => {
  ...
  test('スタッフを作成できる', async ({ page }) => {
    ...
    await page.getByRole('button', { name: '作成' }).click()
    await page.waitForTimeout(2000)
    await expect(page.getByText('E2Eテストスタッフ').first()).toBeVisible()
